#define BME280_ADDRESS 0x76<<1 /*Адрес BME280, p.32, 6.2*/
...
#define BME280_REG_CONFIG 0xF5 /*Регистр конфигурации BME280, задаём время ожидания, значение постоянной времени фильтра BME280, p.29, 5.4.6*/
...
#define BME280_REGISTER_PRESS 0xF7 /*Регистр, откуда читаются данные влажности BME280, p.31, 5.4.9*/
//------------------------------------------------
